...
def get_filters():
    ...
    while True:
        ...
        city= input("\n Which city would you like to check? (Chicago, New York City, Washington) \n").lower()
        if city in cities:
            break
        else:
    ...
    # get user input for month (January, February, March, April, May, June or None)
    while True:
    ...
    # get user input for day of week (Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday, None)
    while True:
